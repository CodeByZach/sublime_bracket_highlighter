...
class BhDebugCommand(sublime_plugin.ApplicationCommand):
    ...
    def run(self, set_value=None):
        ...
        settings = sublime.load_settings("BracketHighlighter.sublime-settings")
    ...
    def is_checked(self):
        ...
        return sublime.load_settings("BracketHighlighter.sublime-settings").get('debug_enable', False)
    ...
    def is_enabled(self, set_value=None):
        ...
        if set_value is None:
            ...
            enabled = not sublime.load_settings("BracketHighlighter.sublime-settings").get('debug_enable', False)
        else:
            enabled = sublime.load_settings("BracketHighlighter.sublime-settings").get('debug_enable', False)
        return enabled
    ...
    def clear_disabled(self, view):
        ...
        disabled = (
            (
                ...
                not sublime.load_settings("BracketHighlighter.sublime-settings").get('search_in_widgets', False)
            ) or
...
def plugin_loaded():
    ...
    global HIGH_VISIBILITY
    if sublime.load_settings("BracketHighlighter.sublime-settings").get('high_visibility_enabled_by_default', False):
